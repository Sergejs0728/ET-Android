 ...
 * {@link TransferAmountFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link TransferAmountFragment#newInstance} factory method to
...
public class TransferAmountFragment extends Fragment {
     ...
     * @return A new instance of fragment TransferAmountFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TransferAmountFragment newInstance(String param1, String param2) {
        TransferAmountFragment fragment = new TransferAmountFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView tv_main = (TextView)view.findViewById(R.id.tv_name);
        TextView tv_mobile = (TextView)view.findViewById(R.id.tv_mobile);
        EditText et_amount = (EditText)view.findViewById(R.id.et_amount);
        TextView tv_usd = (TextView)view.findViewById(R.id.tv_usd);
        ...
        et_amount.setTypeface(roboto_Regular);
        tv_usd.setTypeface(Gotham_Medium);
        et_message.setTypeface(roboto_Regular);
        btn_next.setTypeface(roboto_Medium);

        btn_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                loadFragment(new DonateDoneFragment());
            }
        });
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                loadFragment(new TransferPageFragment());
            }
        });
