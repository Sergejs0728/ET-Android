 ...
 * {@link SplashMainFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SplashMainFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SplashMainFragment extends Fragment {
     ...
     * @return A new instance of fragment SplashMainFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SplashMainFragment newInstance(String param1, String param2) {
        SplashMainFragment fragment = new SplashMainFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView tv_already = (TextView)view.findViewById(R.id.tv_already);
        ...
        tv_already.setTypeface(Roboto_Regular);
        tv_details.setTypeface(Roboto_Regular);

        btn_signIn.setTypeface(Roboto_Medium);
        btn_signUp.setTypeface(Roboto_Medium);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_splash_main, container, false);
    }
