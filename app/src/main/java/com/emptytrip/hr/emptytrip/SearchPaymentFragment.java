 ...
 * {@link SearchPaymentFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SearchPaymentFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SearchPaymentFragment extends Fragment {
     ...
     * @return A new instance of fragment SearchPaymentFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SearchPaymentFragment newInstance(String param1, String param2) {
        SearchPaymentFragment fragment = new SearchPaymentFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_search_payment, container, false);
    }
    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Button btn_addpayment = (Button)view.findViewById(R.id.btn_addpayment);

        tv_topic.setTypeface(roboto_Bold);
        tv_price.setTypeface(roboto_Black);
        tv_note.setTypeface(roboto_Regular);
        btn_addpayment.setTypeface(roboto_Medium);


        Button btn_okay = (Button)view.findViewById(R.id.btn_okay);

        btn_okay.setTypeface(roboto_Medium);

        btn_okay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                loadFragment(new SearchDriverDoneFragment());
            }
        });
    }
