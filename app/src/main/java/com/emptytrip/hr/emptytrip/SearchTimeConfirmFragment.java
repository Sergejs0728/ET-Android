 ...
 * {@link SearchTimeConfirmFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SearchTimeConfirmFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SearchTimeConfirmFragment extends Fragment {
    ...
    public SearchTimeConfirmFragment() {
     ...
     * @return A new instance of fragment SearchTimeConfirmFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SearchTimeConfirmFragment newInstance(String param1, String param2) {
        SearchTimeConfirmFragment fragment = new SearchTimeConfirmFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_search_time_confirm, container, false);
    }
    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                loadFragment(new SearchConfirmPageFragment());
            }
        });
