...
public class PaymentsFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        AdapterPayment adapterPayment = new AdapterPayment(getContext());

        ListView list_payment = (ListView)view.findViewById(R.id.lv_payment);
        list_payment.setAdapter(adapterPayment);

        TextView tv_payment = (TextView)view.findViewById(R.id.tv_payments);

        tv_payment.setTypeface(roboto_Bold);
