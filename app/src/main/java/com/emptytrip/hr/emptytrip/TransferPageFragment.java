 ...
 * {@link TransferPageFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link TransferPageFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TransferPageFragment extends Fragment {
     ...
     * @return A new instance of fragment TransferPageFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TransferPageFragment newInstance(String param1, String param2) {
        TransferPageFragment fragment = new TransferPageFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        EditText et_mobile = (EditText) view.findViewById(R.id.et_mobile);
        Button btn_next = (Button) view.findViewById(R.id.btn_next);

        tv_main.setTypeface(roboto_Black);
        et_mobile.setTypeface(roboto_Regular);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_transfer_page, container, false);
    }
