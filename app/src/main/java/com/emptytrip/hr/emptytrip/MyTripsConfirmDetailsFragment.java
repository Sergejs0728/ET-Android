 ...
 * {@link MyTripsConfirmDetailsFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MyTripsConfirmDetailsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MyTripsConfirmDetailsFragment extends Fragment {
    ...
    public MyTripsConfirmDetailsFragment() {
     ...
     * @return A new instance of fragment MyTripsConfirmDetailsFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static MyTripsConfirmDetailsFragment newInstance(String param1, String param2) {
        MyTripsConfirmDetailsFragment fragment = new MyTripsConfirmDetailsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_my_trips_confirm_details, container, false);
    }
    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                loadFragment(new MyTripsDoneFragment());
            }
        });
