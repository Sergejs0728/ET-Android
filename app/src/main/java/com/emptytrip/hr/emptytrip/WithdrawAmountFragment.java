 ...
 * {@link WithdrawAmountFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link WithdrawAmountFragment#newInstance} factory method to
...
public class WithdrawAmountFragment extends Fragment {
     ...
     * @return A new instance of fragment WithdrawAmountFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static WithdrawAmountFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_withdraw_amount, container, false);
    }
    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                loadFragment(new WithdrawDoneFragment());
            }
        });
