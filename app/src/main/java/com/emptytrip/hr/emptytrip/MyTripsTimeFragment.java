 ...
 * {@link MyTripsTimeFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MyTripsTimeFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MyTripsTimeFragment extends Fragment {
     ...
     * @return A new instance of fragment MyTripsTimeFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static MyTripsTimeFragment newInstance(String param1, String param2) {
        MyTripsTimeFragment fragment = new MyTripsTimeFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_my_trips_time, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                loadFragment(new MyTripsConfirmDetailsFragment());
            }
        });
