...
public class DonateFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView tv_enterpapal = (TextView)view.findViewById(R.id.tv_enterpaypal);
        TextView tv_or = (TextView)view.findViewById(R.id.tv_or);
        ...
        tv_enterpapal.setTypeface(roboto_Regular);
        tv_main.setTypeface(Gotham_Medium);
        tv_or.setTypeface(roboto_Bold);
        tv_note.setTypeface(roboto_Regular);

        et_email.setTypeface(roboto_Medium);
        et_mobilenumber.setTypeface(roboto_Medium);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                loadFragment(new DonateAmountFragment());
            }
        });
